...
public class EventListener implements Listener {
    QueenBeeNetwork plugin;

    public EventListener(QueenBeeNetwork plugin) {
        this.plugin = plugin;
    }
    ...
    public void OnPlayerDataCreatedEvent(PostLoginEvent e) {
        ...
        QueenBeeNetwork.listFriendsInfos.put(uuid, fi);
    ...
    public void OnPlayerDataDumpedEvent(PlayerDisconnectEvent e) {
        ...
        QueenBeeNetwork.listFriendsInfos.get(uuid).DumpData();
        ...
        if(args.size() == 1) {
            ...
            if(args.get(0).equals("/friend") || args.get(0).equals("/f")) {
                if(args.get(1).equals("add")) {
                    FInfo fd = QueenBeeNetwork.listFriendsInfos.get(player.getUniqueId());
                    if(fd != null) {
