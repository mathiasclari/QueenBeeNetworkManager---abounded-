...
import net.acticraft.plugins.queenbeenetwork.util.ChatUtilities;
        ...
        if(sender instanceof ProxiedPlayer) {
            ...
            if(len == 0) {
                ...
                if(args[0].equalsIgnoreCase("add")) {
                    ...
                    if(p != null) {
                        FInfo fi = QueenBeeNetwork.listFriendsInfos.get(player.getUniqueId());
                        FInfo fiOther = QueenBeeNetwork.listFriendsInfos.get(p.getUniqueId());
                    ...
                    if(uuid != null) {
                        FInfo fiOther = QueenBeeNetwork.listFriendsInfos.get(uuid);
